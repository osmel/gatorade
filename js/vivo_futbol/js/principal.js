function CGfxButton(e, t, n, i) {
    ...
    return this._init = function(e, t, n) {
        o = new Array, a = new Array, r = new Array, s = createBitmap(n), s.x = e, s.y = t, l = 1, c = 1, s.regX = n.width / 2, s.regY = n.height / 2, s_bMobile || (s.cursor = "pointer"), u.addChild(s), this._initListener()
        ...
        _ || (l > 0 ? s.scaleX = .9 : s.scaleX = -.9, s.scaleY = .9, o[ON_MOUSE_DOWN] && o[ON_MOUSE_DOWN].call(a[ON_MOUSE_DOWN], r[ON_MOUSE_DOWN]))
    ...
    }, u = void 0 !== i ? i : s_oStage, this._init(e, t, n), d = this, this
}

function TimeSeries(e) {
    e = e || {}, e.resetBoundsInterval = e.resetBoundsInterval || 3e3, e.resetBounds = void 0 === e.resetBounds ? !0 : e.resetBounds, this.options = e, this.data = [], this.label = e.label || "", this.maxDataLength = e.maxDataLength || 1e3, this.dataPool = [], this.maxValue = Number.NaN, this.minValue = Number.NaN, e.resetBounds && (this.boundsTimer = setInterval(function(e) {
        return function() {
            e.resetBounds()
        }
    }(this), e.resetBoundsInterval))
}
...
function SmoothieChart(e) {
    e = e || {}, e.grid = e.grid || {
        ...
        millisPerLine: 1e3,
        verticalSections: 2
    }, e.millisPerPixel = e.millisPerPixel || 20, e.fps = e.fps || 50, e.maxValueScale = e.maxValueScale || 1, e.minValue = e.minValue, e.maxValue = e.maxValue, e.labels = e.labels || {
        fillStyle: "#ffffff"
    }, e.interpolation = e.interpolation || "bezier", e.scaleSmoothing = e.scaleSmoothing || .125, e.maxDataSetLength = e.maxDataSetLength || 2, e.timestampFormatter = e.timestampFormatter || null, this.options = e, this.seriesSet = [], this.currentValueRange = 1, this.currentVisMinValue = 0
}
...
function CLaunchBoard(e) {
    ...
    return this._init = function() {
        t = {
            ...
            y: CANVAS_HEIGHT - 60
        }, a = new createjs.Container, a.x = t.x, a.y = t.y, r.addChild(a), n = new createjs.Text("99" + TEXT_OF + NUM_OF_PENALTY, "50px " + FONT_GAME, TEXT_COLOR), n.textAlign = "right", n.y = -4, a.addChild(n), a.y = t.y, r.addChild(a), i = new createjs.Text("99" + TEXT_OF + NUM_OF_PENALTY, "50px " + FONT_GAME, TEXT_COLOR_STROKE), i.textAlign = "right", i.y = n.y, i.outline = OUTLINE_WIDTH, a.addChild(i);
        var e = s_oSpriteLibrary.getSprite("shot_left");
        o = createBitmap(e), o.x = 1.4 * -n.getBounds().width, o.regX = .5 * e.width, o.regY = 10, a.addChild(o), s = a.getBounds(), this.updateCache()
...
function CPlayer(e, t, n) {
    var i, o, a = new Array,
        ...
        r = 0,
        l = 0;
    return this._init = function(e, t) {
        i = {
            x: e,
            y: t
        }, o = new createjs.Container, o.x = i.x, o.y = i.y, s.addChild(o);
...
function CGame(e) {
    var t, n, i, o, a, s, r, l, c, d, h, u, _, p, E, f, m, g, T, A, S = null,
        v = null,
        b = !1,
        y = !1,
        w = !1,
        ...
        D = null;
    this._init = function() {
        $(s_oMain).trigger("start_session"), this.pause(!0), $(s_oMain).trigger("start_level", M), _ = 0, g = 1, T = new Array, s = new createjs.Container, s_oStage.addChild(s), n = createBitmap(s_oSpriteLibrary.getSprite("bg_game")), n.cache(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT), s.addChild(n), i = new CScenario(M), D = SHOW_3D_RENDER ? camera : createOrthoGraphicCamera();
        var e = s_oSpriteLibrary.getSprite("goal");
        u = new CGoal(291, 28, e, s), S = new CGoalKeeper(CANVAS_WIDTH_HALF - 100, CANVAS_HEIGHT_HALF - 225, s), T.push(S);
        var r = s_oSpriteLibrary.getSprite("ball");
        o = new CBall(0, 0, r, i.ballBody(), s), T.push(o), this.ballPosition(), o.setVisible(!1), m = MS_TIME_SWIPE_START, a = new CStartBall(CANVAS_WIDTH_HALF + 55, CANVAS_HEIGHT_HALF + 168, s), d = new CPlayer(CANVAS_WIDTH_HALF - 150, CANVAS_HEIGHT_HALF - 320, s), d.setVisible(!1);
        var l = "cursor";
        s_bMobile && (l = "hand_touch"), h = new CHandSwipeAnim(START_HAND_SWIPE_POS, END_HAND_SWIPE_POS, s_oSpriteLibrary.getSprite(l), s_oStage), h.animAllSwipe(), resizeCanvas3D(), setVolume(s_oSoundTrack, .35), t = new CInterface, t.refreshTextScoreBoard(0, 0, 0, !1), t.refreshLaunchBoard(I, NUM_OF_PENALTY), A = new CANNON.Vec3(0, 0, 0), this.onExitHelp()
    }, this.createControl = function() {
        SHOW_3D_RENDER ? (window.addEventListener("mousedown", this.onMouseDown), window.addEventListener("mousemove", this.onPressMove), window.addEventListener("mouseup", this.onPressUp)) : (c = new createjs.Shape, c.graphics.beginFill("rgba(255,0,0,0.01)").drawRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT), s.addChild(c), c.on("mousedown", this.onMouseDown), c.on("pressmove", this.onPressMove), c.on("pressup", this.onPressUp))
    }, this.sortDepth = function(e, t) {
        e.getDepthPos() > t.getDepthPos() ? s.getChildIndex(e.getObject()) > s.getChildIndex(t.getObject()) && s.swapChildren(e.getObject(), t.getObject()) : e.getDepthPos() < t.getDepthPos() && s.getChildIndex(t.getObject()) > s.getChildIndex(e.getObject()) && s.swapChildren(t.getObject(), e.getObject())
    }, this.onExitHelp = function() {
        this.createControl(), this.pause(!1)
    }, this.poleCollide = function() {
        f = TIME_POLE_COLLISION_RESET, N = !0, playSound("pole", .4, 0)
    }, this.fieldCollision = function() {
        null === v && y && (v = playSound("drop_bounce_grass", .3, 0), v.on("complete", function() {
        ...
        y || (m = MS_TIME_SWIPE_START, h.removeTweens(), h.setVisible(!1), r = {
            x: s_oStage.mouseX,
            y: s_oStage.mouseY
        })
        ...
        _ += e, t.refreshTextScoreBoard(_, g.toFixed(1), n, !0)
        ...
        switch (o.getPhysics().velocity.negate(o.getPhysics().velocity), p) {
            case 12:
                o.getPhysics().velocity = o.getPhysics().velocity.vadd(new CANNON.Vec3(.4 * o.getPhysics().velocity.x, .4 * o.getPhysics().velocity.y, .4 * o.getPhysics().velocity.z));
                break;
            default:
        ...
        if (!y && G === STATE_PLAY) {
            var t = i.ballBody();
            i.addImpulse(t, e), i.setElementAngularVelocity(t, {
                x: 0,
                y: 0,
                z: 0
            }), y = !0, o.setVisible(!0), a.setVisible(!1), this.chooseDirectionGoalKeeper(e), playSound("kick", 1, 0)
        }
        ...
        var e = i.ballBody();
        e.position.set(POSITION_BALL.x, POSITION_BALL.y, POSITION_BALL.z), i.setElementVelocity(e, {
            x: 0,
            y: 0,
            z: 0
        }), i.setElementAngularVelocity(e, {
            x: 0,
            y: 0,
            z: 0
        }), o.fadeAnimation(1, 500, 0), o.setVisible(!1), a.setVisible(!0), a.setAlpha(0), a.fadeAnim(1, 500, 0)
        ...
        var n = new THREE.Vector3(e.x, e.y, e.z),
            i = n.project(t),
            o = .5 * Math.floor(s_iCanvasResizeWidth),
            a = .5 * Math.floor(s_iCanvasResizeHeight);
        ...
        I < NUM_OF_PENALTY ? (I++, t.refreshLaunchBoard(I, NUM_OF_PENALTY), this.resetScene(), y = !1, m = MS_TIME_SWIPE_START) : (G = STATE_FINISH, _ > s_iBestScore && (s_iBestScore = Math.floor(_), saveItem(LOCALSTORAGE_STRING[LOCAL_BEST_SCORE], Math.floor(_))), t.createWinPanel(Math.floor(_)), $(s_oMain).trigger("end_level", M))
        ...
        e > FORCE_BALL_DISPLAY_SHOCK[0].min && e < FORCE_BALL_DISPLAY_SHOCK[0].max ? this.displayShock(INTENSITY_DISPLAY_SHOCK[0].time, INTENSITY_DISPLAY_SHOCK[0].x, INTENSITY_DISPLAY_SHOCK[0].y) : e > FORCE_BALL_DISPLAY_SHOCK[1].min && e < FORCE_BALL_DISPLAY_SHOCK[1].max ? this.displayShock(INTENSITY_DISPLAY_SHOCK[1].time, INTENSITY_DISPLAY_SHOCK[1].x, INTENSITY_DISPLAY_SHOCK[1].y) : e > FORCE_BALL_DISPLAY_SHOCK[2].min && e < FORCE_BALL_DISPLAY_SHOCK[2].max ? this.displayShock(INTENSITY_DISPLAY_SHOCK[2].time, INTENSITY_DISPLAY_SHOCK[2].x, INTENSITY_DISPLAY_SHOCK[2].y) : e > FORCE_BALL_DISPLAY_SHOCK[3].min && this.displayShock(INTENSITY_DISPLAY_SHOCK[3].time, INTENSITY_DISPLAY_SHOCK[3].x, INTENSITY_DISPLAY_SHOCK[3].y)
        ...
        createjs.Tween.get(s).to({
            ...
            createjs.Tween.get(s).to({
                x: Math.round(Math.random() * i * .8),
                y: -Math.round(Math.random() * o * .8)
            }, e).call(function() {
                createjs.Tween.get(s).to({
                    x: Math.round(Math.random() * i * .6),
                    y: Math.round(Math.random() * o * .6)
                }, e).call(function() {
                    createjs.Tween.get(s).to({
                        x: Math.round(Math.random() * i * .4),
                        y: -Math.round(Math.random() * o * .4)
                    }, e).call(function() {
                        createjs.Tween.get(s).to({
                            x: Math.round(Math.random() * i * .2),
        ...
        for (var e = 0; e < T.length - 1; e++)
            for (var t = e + 1; t < T.length; t++) T[e].getObject().visible && T[t].getObject().visible && this.sortDepth(T[e], T[t])
    }, this.ballOut = function() {
        if (!w && !b && !L) {
            var e = o.getPhysics().position;
            (e.y > BALL_OUT_Y || e.x > BACK_WALL_GOAL_SIZE.width || e.x < -BACK_WALL_GOAL_SIZE.width) && (w = !0, E = TIME_RESET_AFTER_BALL_OUT, t.createAnimText(TEXT_BALL_OUT, 90, !1, TEXT_COLOR_1, TEXT_COLOR_STROKE), playSound("ball_saved", 1, 0), g = 1, H = 0)
        }
    }, this.animPlayer = function() {
        return O ? (O = d.animPlayer(), void(d.getFrame() === SHOOT_FRAME && (this.addImpulseToBall({
            x: A.x,
            y: A.y,
            z: A.z
        }), P = 0, this.goalAnimation(A.y), t.unloadHelpText()))) : void d.setVisible(!1)
    ...
    }, s_oGame = this, AREAS_INFO = e.area_goal, NUM_OF_PENALTY = e.num_of_penalty, MULTIPLIER_STEP = e.multiplier_step, NUM_LEVEL_FOR_ADS = e.num_levels_for_ads, ENABLE_FULLSCREEN = e.fullscreen, this._init()
}

function CWinPanel(e) {
    var t, n, i, o, a, s, r, l, c, d, h;
    return this._init = function(e) {
        var u = 50;
        l = new createjs.Container, l.alpha = 0, l.visible = !1;
        var _ = new createjs.Shape;
        _.graphics.beginFill("black").drawRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT), _.alpha = .5, l.addChild(_), t = createBitmap(e), t.x = CANVAS_WIDTH_HALF, t.y = CANVAS_HEIGHT_HALF, t.regX = .5 * e.width, t.regY = .5 * e.height, l.addChild(t), n = new createjs.Text("", "80px " + FONT_GAME, TEXT_COLOR_STROKE), n.x = CANVAS_WIDTH / 2, n.y = CANVAS_HEIGHT_HALF - 170, n.textAlign = "center", n.outline = 5, l.addChild(n), i = new createjs.Text("", "80px " + FONT_GAME, TEXT_COLOR), i.x = CANVAS_WIDTH / 2, i.y = n.y, i.textAlign = "center", l.addChild(i), o = new createjs.Text("", u + "px " + FONT_GAME, TEXT_COLOR_STROKE), o.x = CANVAS_WIDTH / 2, o.y = CANVAS_HEIGHT_HALF - 50, o.textAlign = "center", o.outline = 5, l.addChild(o), a = new createjs.Text("", u + "px " + FONT_GAME, TEXT_COLOR), a.x = CANVAS_WIDTH / 2, a.y = o.y, a.textAlign = "center", l.addChild(a), s = new createjs.Text("", u + "px " + FONT_GAME, TEXT_COLOR_STROKE), s.x = CANVAS_WIDTH / 2, s.y = CANVAS_HEIGHT_HALF + 50, s.textAlign = "center", s.outline = 5, l.addChild(s), r = new createjs.Text("", u + "px " + FONT_GAME, TEXT_COLOR), r.x = CANVAS_WIDTH / 2, r.y = s.y, r.textAlign = "center", l.addChild(r);
        var p = s_oSpriteLibrary.getSprite("but_restart");
        d = new CGfxButton(.5 * CANVAS_WIDTH + 250, .5 * CANVAS_HEIGHT + 120, p, l), d.pulseAnimation(), d.addEventListener(ON_MOUSE_DOWN, this._onRestart, this);
        var E = s_oSpriteLibrary.getSprite("but_home");
        c = new CGfxButton(.5 * CANVAS_WIDTH - 250, .5 * CANVAS_HEIGHT + 120, E, l), c.addEventListener(ON_MOUSE_DOWN, this._onExit, this), h = new createjs.Container, l.addChild(h), l.on("click", function() {}), s_oStage.addChild(l)
    }, this.unload = function() {
        l.removeAllEventListeners(), s_oStage.removeChild(l), c && (c.unload(), c = null), d && (d.unload(), d = null)
    }, this.show = function(e) {
        n.text = TEXT_GAMEOVER, i.text = TEXT_GAMEOVER, o.text = TEXT_SCORE + ": " + e, a.text = TEXT_SCORE + ": " + e, s.text = TEXT_BEST_SCORE + ": " + s_iBestScore, r.text = TEXT_BEST_SCORE + ": " + s_iBestScore, l.visible = !0, createjs.Tween.get(l).wait(MS_WAIT_SHOW_GAME_OVER_PANEL).to({
            alpha: 1
        ...
        }), $(s_oMain).trigger("save_score", e), $(s_oMain).trigger("share_event", e)
        ...
        createjs.Tween.get(l, {
            ...
            e.unload()
        }), _oButContinue.block(!0), c.block(!0), s_oGame.onContinue()
...
function CToggle(e, t, n, i, o) {
    ...
    this._init = function(e, t, n, i, o) {
        ...
        l.scaleX = .9, l.scaleY = .9, s[ON_MOUSE_DOWN] && s[ON_MOUSE_DOWN].call(r[ON_MOUSE_DOWN])
    }, this.setPosition = function(e, t) {
        l.x = e, l.y = t
...
function CAreYouSurePanel(e) {
    var t, n, i, o, a, s, r;
    this._init = function() {
        a = new createjs.Container, a.alpha = 0, s.addChild(a), r = new createjs.Shape, r.graphics.beginFill("black").drawRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT), r.alpha = .5, r.on("click", function() {}), a.addChild(r);
        var e = s_oSpriteLibrary.getSprite("msg_box");
        t = createBitmap(e), t.x = CANVAS_WIDTH_HALF, t.y = CANVAS_HEIGHT_HALF, t.regX = .5 * e.width, t.regY = .5 * e.height, a.addChild(t), n = new createjs.Text(TEXT_ARE_SURE, "70px " + FONT_GAME, "#ffffff"), n.x = CANVAS_WIDTH / 2, n.y = CANVAS_HEIGHT_HALF - 50, n.textAlign = "center", n.textBaseline = "middle", a.addChild(n), i = new CGfxButton(CANVAS_WIDTH / 2 + 250, .5 * CANVAS_HEIGHT + 120, s_oSpriteLibrary.getSprite("but_yes"), a), i.addEventListener(ON_MOUSE_UP, this._onButYes, this), o = new CGfxButton(CANVAS_WIDTH / 2 - 250, .5 * CANVAS_HEIGHT + 120, s_oSpriteLibrary.getSprite("but_no"), a), o.addEventListener(ON_MOUSE_UP, this._onButNo, this)
    }, this.show = function() {
...
function CSpriteLibrary() {
    ...
    this.init = function(s, r, l) {
        ...
        for (var t in e) e[t].oSprite.oSpriteLibrary = this, e[t].oSprite.onload = function() {
...
function CGoalKeeper(e, t, n) {
    ...
    return this._init = function(e, t, n) {
        s = n, i = {
            x: e,
            y: t
        }, o = new createjs.Container, o.x = i.x, o.y = i.y, s.addChild(o), o.tickChildren = !1, r = new Array, a = new Array;
    ...
    }, this._init(e, t, n), this
}

function CRollingScore() {
    var e = null,
        t = null;
    return this.rolling = function(n, i, o) {
        e = createjs.Tween.get(n, {
            override: !0
        }).to({
            text: o
...
function getSize(e) {
    ...
    if (void 0 === window["inner" + e]) t = o["client" + e];
        ...
        s.id = "vpw-test-d", s.style.cssText = "position:absolute;top:-1000px", s.innerHTML = "<style>@media(" + n + ":" + o["client" + e] + "px){body#vpw-test-b div#vpw-test-d{" + n + ":7px!important}}</style>", a.appendChild(s), o.insertBefore(a, i.head), t = 7 == s["offset" + e] ? o["client" + e] : window["inner" + e], o.removeChild(a)
...
function sizeHandler() {
    if (window.scrollTo(0, 1), $("#canvas")) {
        var e, t = !!navigator.userAgent.match(/(iPad|iPhone|iPod)/g);
        ...
        var s = e / 2 - o / 2,
            r = n / 2 - i / 2,
            l = CANVAS_WIDTH / i;
        (-EDGEBOARD_X > r * l || -EDGEBOARD_Y > s * l) && (s_iScaleFactor = Math.min(e / (CANVAS_HEIGHT - 2 * EDGEBOARD_Y), n / (CANVAS_WIDTH - 2 * EDGEBOARD_X)), i = CANVAS_WIDTH * s_iScaleFactor, o = CANVAS_HEIGHT * s_iScaleFactor, s = (e - o) / 2, r = (n - i) / 2, l = CANVAS_WIDTH / i), s_fInverseScaling = l, s_iOffsetX = -1 * r * l, s_iOffsetY = -1 * s * l, s >= 0 && (s_iOffsetY = 0), r >= 0 && (s_iOffsetX = 0), null !== s_oInterface && s_oInterface.refreshButtonPos(s_iOffsetX, s_iOffsetY), null !== s_oMenu && s_oMenu.refreshButtonPos(s_iOffsetX, s_iOffsetY), $("#canvas").css("width", i + "px"), $("#canvas").css("height", o + "px"), 0 > s ? ($("#canvas").css("top", s + "px"), s_iCanvasOffsetHeight = s) : ($("#canvas").css("top", "0px"), s_iCanvasOffsetHeight = 0), $("#canvas").css("left", r + "px"), resizeCanvas3D(), s_iCanvasResizeWidth = i, s_iCanvasResizeHeight = o, s_iCanvasOffsetWidth = r
    }
}
...
function checkRectCollision(e, t) {
    var n, i;
    return n = getBounds(e, .9), i = getBounds(t, .98), calculateIntersection(n, i)
}

function calculateIntersection(e, t) {
    var n, i, o = {},
        a = {};
    return o.cx = e.x + (o.hw = e.width / 2), o.cy = e.y + (o.hh = e.height / 2), a.cx = t.x + (a.hw = t.width / 2), a.cy = t.y + (a.hh = t.height / 2), n = Math.abs(o.cx - a.cx) - (o.hw + a.hw), i = Math.abs(o.cy - a.cy) - (o.hh + a.hh), 0 > n && 0 > i ? (n = Math.min(Math.min(e.width, t.width), -n), i = Math.min(Math.min(e.height, t.height), -i), {
        x: Math.max(e.x, t.x),
        y: Math.max(e.y, t.y),
        width: n,
        height: i,
...
function getBounds(e, t) {
    ...
    if (e instanceof createjs.Container) {
        ...
        u.regX = u.regX || 0, u.width = u.width || 0, u.regY = u.regY || 0, u.height = u.height || 0, n.regX = u.regX, n.regY = u.regY, r = e.localToGlobal(0 - u.regX, 0 - u.regY), l = e.localToGlobal(u.width - u.regX, u.height - u.regY), c = e.localToGlobal(u.width - u.regX, 0 - u.regY), d = e.localToGlobal(0 - u.regX, u.height - u.regY), n.x = Math.min(Math.min(Math.min(r.x, l.x), c.x), d.x), n.y = Math.min(Math.min(Math.min(r.y, l.y), c.y), d.y), n.width = Math.max(Math.max(Math.max(r.x, l.x), c.x), d.x) - n.x, n.height = Math.max(Math.max(Math.max(r.y, l.y), c.y), d.y) - n.y
    }
    return n
}
...
function findNearestIntersectingObject(e, t, n, i) {
    var o = CANVAS_RESIZE_WIDTH + 2 * OFFSET_WIDTH,
        ...
        r = new THREE.Vector3;
    r.x = e / o * 2 - 1, r.y = 2 * -(t / a) + 1, r.z = .5, s.setFromCamera(r, n);
...
function createOrthoGraphicCamera() {
    ...
    return e.rotation.x = 88.6 * (Math.PI / 180), e.rotation.y = .03 * (Math.PI / 180), e.position.set(CAMERA_POSITION.x, CAMERA_POSITION.y, CAMERA_POSITION.z), e.updateProjectionMatrix(), e.updateMatrixWorld(), e
}
...
function CStartBall(e, t, n) {
    ...
    return this._init = function() {
        ...
        i = createBitmap(n), i.regX = .5 * n.width, i.regY = .5 * n.height, this.setPosition(e, t), o.addChild(i)
    }, this.setPosition = function(e, t) {
        i.x = e, i.y = t
...
function CScoreBoard(e) {
    ...
    return this._init = function() {
        t = {
            x: CANVAS_WIDTH_HALF - 660,
            y: CANVAS_HEIGHT - 64
        }, d = new createjs.Container, d.x = t.x, d.y = t.y, u.addChild(d), i = new createjs.Text(TEXT_SCORE, "50px " + FONT_GAME, TEXT_COLOR), i.textAlign = "left", d.addChild(i), o = new createjs.Text(TEXT_SCORE, "50px " + FONT_GAME, TEXT_COLOR_STROKE), o.textAlign = "left", o.outline = OUTLINE_WIDTH, d.addChild(o), a = new createjs.Text(999999, "50px " + FONT_GAME, TEXT_COLOR), a.textAlign = "left", a.x = 150, d.addChild(a), s = new createjs.Text(999999, "50px " + FONT_GAME, TEXT_COLOR_STROKE), s.textAlign = "left", s.x = a.x, s.outline = OUTLINE_WIDTH, d.addChild(s), h = new createjs.Container, h.x = 50, r = new createjs.Text("+5555 " + TEXT_MULTIPLIER + 1, "36px " + FONT_GAME, TEXT_COLOR), r.textAlign = "left", h.addChild(r), l = new createjs.Text("+5555 " + TEXT_MULTIPLIER + 1, "36px " + FONT_GAME, TEXT_COLOR_STROKE), l.textAlign = "left", l.outline = OUTLINE_WIDTH, h.addChild(l), h.y = n = -l.getBounds().height, h.visible = !1, d.addChild(h), c = new CRollingScore
        ...
        h.visible = !0, r.text = "+" + e + " " + TEXT_MULTIPLIER + t, l.text = r.text, createjs.Tween.get(h).to({
            y: n - 50,
            alpha: 0
...
function CInterface() {
    var e, t, n, i, o, a, s, r, l, c, d, h, u, _, p = null,
        E = null,
        f = null;
    return this._init = function() {
        i = {
        ...
        t = {
            ...
            y: c.height / 2 + 10
        }, a = new CGfxButton(t.x, t.y, c), a.addEventListener(ON_MOUSE_UP, this._onExit, this);
        var c = s_oSpriteLibrary.getSprite("but_pause");
        if (n = {
                x: t.x - c.height - 10,
                y: t.y
            }, s = new CGfxButton(n.x, n.y, c), s.addEventListener(ON_MOUSE_UP, this.onButPauseRelease, this), DISABLE_SOUND_MOBILE === !1 || s_bMobile === !1) {
            var c = s_oSpriteLibrary.getSprite("audio_icon");
            e = {
                x: n.x - c.height - 10,
                y: t.y
            }, l = new CToggle(e.x, e.y, c, s_bAudioActive), l.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this)
        }
        var _ = window.document,
            p = _.documentElement;
        E = p.requestFullscreen || p.mozRequestFullScreen || p.webkitRequestFullScreen || p.msRequestFullscreen, f = _.exitFullscreen || _.mozCancelFullScreen || _.webkitExitFullscreen || _.msExitFullscreen, ENABLE_FULLSCREEN === !1 && (E = !1), E && !inIframe() && (c = s_oSpriteLibrary.getSprite("but_fullscreen"), o = {
            x: c.width / 4 + 10,
            y: c.height / 2 + 10
        }, r = new CToggle(o.x, o.y, c, !1, s_oStage), r.addEventListener(ON_MOUSE_UP, this._onFullscreen, this)), d = new CScoreBoard(s_oStage), h = new CLaunchBoard(s_oStage), u = new CHelpText(s_oStage), u.fadeAnim(1, null), this.refreshButtonPos(s_iOffsetX, s_iOffsetY)
        ...
        a.x = 0, a.y = 0, a.textAlign = "center", i.addChild(a), i.x = CANVAS_WIDTH_HALF, i.y = -o.getBounds().height, n && s_oInterface.strobeText(a), s_oStage.addChild(i), createjs.Tween.get(i).to({
            y: CANVAS_HEIGHT_HALF
        }, 500, createjs.Ease.cubicOut).call(function() {
            createjs.Tween.get(i).wait(250).to({
                y: CANVAS_HEIGHT + o.getBounds().height
...
function CHelpText(e) {
    var t, n, i, o = e;
    return this._init = function() {
        i = new createjs.Container, o.addChild(i), t = new createjs.Text(TEXT_HELP, "42px " + FONT_GAME, TEXT_COLOR), t.x = CANVAS_WIDTH / 2, t.y = CANVAS_HEIGHT_HALF, t.textAlign = "center", i.addChild(t), n = new createjs.Text(TEXT_HELP, "42px " + FONT_GAME, TEXT_COLOR_STROKE), n.x = CANVAS_WIDTH / 2, n.y = t.y, n.textAlign = "center", n.outline = OUTLINE_WIDTH, i.addChild(n), i.alpha = 0
...
function CScenario() {
    ...
    this.getDemo = function() {
        ...
        e = SHOW_3D_RENDER ? m.getWorld() : new CANNON.World, f = new Array, e.gravity.set(0, 0, -9.81), e.broadphase = new CANNON.NaiveBroadphase, e.solver.iterations = 50, e.solver.tolerance = 1e-5, t = new CANNON.Material, n = new CANNON.Material, i = new CANNON.Material;
        var o = new CANNON.ContactMaterial(n, i, {
                friction: .1,
                restitution: .01
            }),
            a = new CANNON.ContactMaterial(n, t, {
                friction: .2,
                restitution: .3
            });
        e.addContactMaterial(o), e.addContactMaterial(a), s_oScenario._createBallBody(), s_oScenario._createFieldBody(), s_oScenario._createGoal(), s_oScenario.createBackGoalWall(), SHOW_AREAS_GOAL ? s_oScenario.createAreasGoal() : s_oScenario.createAreaGoal(GOAL_LINE_POS, BACK_WALL_GOAL_SIZE, COLOR_AREA_GOAL[0], null)
    }, this.createAreasGoal = function() {
        for (var e = 0, t = FIRST_AREA_GOAL_POS.x, n = FIRST_AREA_GOAL_POS.z, i = 0; i < NUM_AREA_GOAL.h; i++) {
            for (var o = 0; o < NUM_AREA_GOAL.w; o++) s_oScenario.createAreaGoal({
                x: t,
                y: FIRST_AREA_GOAL_POS.y,
                z: n
            }, AREA_GOAL_PROPERTIES, COLOR_AREA_GOAL[e], AREAS_INFO[e]), t += 2 * AREA_GOAL_PROPERTIES.width, e++;
            t = FIRST_AREA_GOAL_POS.x, n -= 2 * AREA_GOAL_PROPERTIES.height
        }
    }, this._createFieldBody = function() {
        if (r = new CANNON.Plane, l = new CANNON.Body({
                mass: 0,
                material: t
            }), l.addShape(r), l.position.z = -9, l.addEventListener("collide", function(e) {
                s_oScenario.fieldCollision()
            }), e.addBody(l), SHOW_3D_RENDER) {
        ...
        c = new CANNON.Cylinder(POLE_RIGHT_LEFT_SIZE.radius_top, POLE_RIGHT_LEFT_SIZE.radius_bottom, POLE_RIGHT_LEFT_SIZE.height, POLE_RIGHT_LEFT_SIZE.segments), h = new CANNON.Body({
            mass: 0
        ...
        if (t.setFromAxisAngle(new CANNON.Vec3(0, 1, 0), Math.PI / 2), d.transformAllPoints(new CANNON.Vec3, t), h.addShape(c, new CANNON.Vec3(.5 * POLE_UP_SIZE.height, 0, 0)), h.addShape(c, new CANNON.Vec3(.5 * -POLE_UP_SIZE.height, 0, 0)), h.addShape(d, new CANNON.Vec3(0, 0, .5 * POLE_RIGHT_LEFT_SIZE.height)), h.position.set(BACK_WALL_GOAL_POSITION.x, BACK_WALL_GOAL_POSITION.y - UP_WALL_GOAL_SIZE.depth, BACK_WALL_GOAL_POSITION.z), h.addEventListener("collide", function(e) {
                s_oScenario.poleCollision()
            }), e.addBody(h), SHOW_3D_RENDER) {
            var n = new THREE.MeshPhongMaterial({
                color: 16777215,
                specular: 1118481,
                shininess: 50
        ...
        u = new CANNON.Box(new CANNON.Vec3(BACK_WALL_GOAL_SIZE.width, BACK_WALL_GOAL_SIZE.depth, BACK_WALL_GOAL_SIZE.height)), _ = new CANNON.Box(new CANNON.Vec3(LEFT_RIGHT_WALL_GOAL_SIZE.width, LEFT_RIGHT_WALL_GOAL_SIZE.depth, LEFT_RIGHT_WALL_GOAL_SIZE.height)), p = new CANNON.Box(new CANNON.Vec3(UP_WALL_GOAL_SIZE.width, UP_WALL_GOAL_SIZE.depth, UP_WALL_GOAL_SIZE.height)), E = new CANNON.Body({
            mass: 0,
            material: i
        }), E.addShape(u), E.addShape(_, new CANNON.Vec3(BACK_WALL_GOAL_SIZE.width, 0, 0)), E.addShape(_, new CANNON.Vec3(-BACK_WALL_GOAL_SIZE.width, 0, 0)), E.addShape(p, new CANNON.Vec3(0, 0, BACK_WALL_GOAL_SIZE.height)), E.position.set(BACK_WALL_GOAL_POSITION.x, BACK_WALL_GOAL_POSITION.y, BACK_WALL_GOAL_POSITION.z), e.addBody(E), SHOW_3D_RENDER && m.addVisual(E)
        ...
        if (s.addShape(a), s.position.set(t.x, t.y, t.z), s.collisionResponse = 0, s.addEventListener("collide", function(e) {
                s_oScenario.lineGoalCollision(e)
            }), e.addBody(s), SHOW_3D_RENDER) {
        ...
        o = new CANNON.Sphere(BALL_RADIUS), a = new CANNON.Body({
            mass: BALL_MASS,
            material: n,
        ...
        e = null
    }, s_oScenario = this, SHOW_3D_RENDER ? (m.addScene("Test", this._init), m.start()) : this._init()
}

function CBall(e, t, n, i, o) {
    var a, s, r, l, c, d = null,
        h = FOV * BALL_RADIUS,
        u = h,
        _ = 0,
        p = 0,
    ...
    return this._init = function(e, t, n) {
        ...
        l = createBitmap(r), l.x = e, l.y = t, l.regX = .5 * r.width, l.regY = .5 * r.height, this.scaleShadow(u), c.addChild(l, a)
    }, this.rolls = function() {
        var e = .15 * r.velocity.x,
            t = Math.sin(-e);
        a.rotation = Math.degrees(t);
        var n = Math.abs(r.angularVelocity.x),
            i = this._goToPrevFrame;
        r.angularVelocity.x < 0 && (i = this._goToNextFrame), n > 7 ? i() : n > 3 ? (_++, _ > 2 / ROLL_BALL_RATE && (i(), _ = 0)) : n > 1 ? (_++, _ > 3 / ROLL_BALL_RATE && (i(), _ = 0)) : n > MIN_BALL_VEL_ROTATION && (_++, _ > 4 / ROLL_BALL_RATE && (i(), _ = 0))
        ...
        e > .08 ? (l.scaleX = e, l.scaleY = e) : (l.scaleX = .08, l.scaleY = .08)
...
function CMain(e) {
    ...
    this.initContainer = function() {
        ...
        s_oStage = new createjs.Stage(e), createjs.Touch.enable(s_oStage), s_oStage.preventSelection = !1, s_bMobile = jQuery.browser.mobile, s_bMobile === !1 ? (s_oStage.enableMouseOver(20), $("body").on("contextmenu", "#canvas", function(e) {
            return !1
        }), FPS = FPS_DESKTOP, FPS_TIME = 1 / FPS, PHYSICS_STEP = 1 / (FPS * STEP_RATE), ROLL_BALL_RATE = 60 / FPS) : BALL_VELOCITY_MULTIPLIER = .8, s_iPrevTime = (new Date).getTime(), createjs.Ticker.addEventListener("tick", this._update), createjs.Ticker.setFPS(FPS), navigator.userAgent.match(/Windows Phone/i) && (DISABLE_SOUND_MOBILE = !0), s_oSpriteLibrary = new CSpriteLibrary, i = new CPreloader, t = !0
    }, this.soundLoaded = function() {
        r++;
        var e = Math.floor(r / l * 100);
        i.refreshLoader(e), r === l && (i.unload(), DISABLE_SOUND_MOBILE !== !1 && s_bMobile !== !1 || (s_oSoundTrack = createjs.Sound.play("soundtrack", {
            loop: -1
        })), this.gotoMenu())
    }, this._initSounds = function() {
        createjs.Sound.initializeDefaultPlugins() && (navigator.userAgent.indexOf("Opera") > 0 || navigator.userAgent.indexOf("OPR") > 0 ? (createjs.Sound.alternateExtensions = ["mp3"], createjs.Sound.addEventListener("fileload", createjs.proxy(this.soundLoaded, this)), createjs.Sound.registerSound("./js/vivo_futbol/sounds/click.ogg", "click"), createjs.Sound.registerSound("./js/vivo_futbol/sounds/drop_bounce_grass.ogg", "drop_bounce_grass"), createjs.Sound.registerSound("./js/vivo_futbol/sounds/soundtrack.ogg", "soundtrack"), createjs.Sound.registerSound("./js/vivo_futbol/sounds/goal.ogg", "goal"), createjs.Sound.registerSound("./js/vivo_futbol/sounds/ball_saved.ogg", "ball_saved"), createjs.Sound.registerSound("./js/vivo_futbol/sounds/kick.ogg", "kick"), createjs.Sound.registerSound("./js/vivo_futbol/sounds/pole.ogg", "pole")) : (createjs.Sound.alternateExtensions = ["ogg"], createjs.Sound.addEventListener("fileload", createjs.proxy(this.soundLoaded, this)), createjs.Sound.registerSound("./js/vivo_futbol/sounds/click.mp3", "click"), createjs.Sound.registerSound("./js/vivo_futbol/sounds/drop_bounce_grass.mp3", "drop_bounce_grass"), createjs.Sound.registerSound("./js/vivo_futbol/sounds/soundtrack.mp3", "soundtrack"), createjs.Sound.registerSound("./js/vivo_futbol/sounds/goal.mp3", "goal"), createjs.Sound.registerSound("./js/vivo_futbol/sounds/ball_saved.mp3", "ball_saved"), createjs.Sound.registerSound("./js/vivo_futbol/sounds/kick.mp3", "kick"), createjs.Sound.registerSound("./js/vivo_futbol/sounds/pole.mp3", "pole")), l += 7)
    }, this._loadImages = function() {
        s_oSpriteLibrary.init(this._onImagesLoaded, this._onAllImagesLoaded, this), s_oSpriteLibrary.addSprite("but_play", "./js/vivo_futbol/sprites/but_play.png"), s_oSpriteLibrary.addSprite("but_exit", "./js/vivo_futbol/sprites/but_exit.png"), s_oSpriteLibrary.addSprite("bg_menu", "./js/vivo_futbol/sprites/bg_menu.jpg"), s_oSpriteLibrary.addSprite("bg_game", "./js/vivo_futbol/sprites/bg_game.jpg"), s_oSpriteLibrary.addSprite("msg_box", "./js/vivo_futbol/sprites/msg_box.png"), s_oSpriteLibrary.addSprite("audio_icon", "./js/vivo_futbol/sprites/audio_icon.png"), s_oSpriteLibrary.addSprite("but_home", "./js/vivo_futbol/sprites/but_home.png"), s_oSpriteLibrary.addSprite("but_restart", "./js/vivo_futbol/sprites/but_restart.png"), s_oSpriteLibrary.addSprite("but_fullscreen", "./js/vivo_futbol/sprites/but_fullscreen.png"), s_oSpriteLibrary.addSprite("ball", "./js/vivo_futbol/sprites/ball.png"), s_oSpriteLibrary.addSprite("but_level", "./js/vivo_futbol/sprites/but_level.png"), s_oSpriteLibrary.addSprite("bg_game", "./js/vivo_futbol/sprites/bg_game.jpg"), s_oSpriteLibrary.addSprite("but_continue", "./js/vivo_futbol/sprites/but_continue.png"), s_oSpriteLibrary.addSprite("but_yes", "./js/vivo_futbol/sprites/but_yes.png"), s_oSpriteLibrary.addSprite("but_no", "./js/vivo_futbol/sprites/but_no.png"), s_oSpriteLibrary.addSprite("but_info", "./js/vivo_futbol/sprites/but_info.png"), s_oSpriteLibrary.addSprite("logo_ctl", "./js/vivo_futbol/sprites/logo_ctl.png"), s_oSpriteLibrary.addSprite("but_pause", "./js/vivo_futbol/sprites/but_pause.png"), s_oSpriteLibrary.addSprite("arrow_right", "./js/vivo_futbol/sprites/arrow_right.png"), s_oSpriteLibrary.addSprite("arrow_left", "./js/vivo_futbol/sprites/arrow_left.png"), s_oSpriteLibrary.addSprite("ball_shadow", "./js/vivo_futbol/sprites/ball_shadow.png"), s_oSpriteLibrary.addSprite("start_ball", "./js/vivo_futbol/sprites/start_ball.png"), s_oSpriteLibrary.addSprite("hand_touch", "./js/vivo_futbol/sprites/hand_touch.png"), s_oSpriteLibrary.addSprite("cursor", "./js/vivo_futbol/sprites/cursor.png"), s_oSpriteLibrary.addSprite("shot_left", "./js/vivo_futbol/sprites/shot_left.png"), s_oSpriteLibrary.addSprite("goal", "./js/vivo_futbol/sprites/goal.png");
        for (var e = 0; NUM_SPRITE_PLAYER > e; e++) s_oSpriteLibrary.addSprite("player_" + e, "./js/vivo_futbol/sprites/player/player_" + e + ".png");
        for (var e = 0; e < NUM_SPRITE_GOALKEEPER[IDLE]; e++) s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[IDLE] + e, "./js/vivo_futbol/sprites/goalkeeper_idle/gk_idle_" + e + ".png");
        for (var e = 0; e < NUM_SPRITE_GOALKEEPER[RIGHT]; e++) s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[RIGHT] + e, "./js/vivo_futbol/sprites/goalkeeper_save_right/gk_save_right_" + e + ".png");
        for (var e = 0; e < NUM_SPRITE_GOALKEEPER[LEFT]; e++) s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[LEFT] + e, "./js/vivo_futbol/sprites/goalkeeper_save_left/gk_save_left_" + e + ".png");
        for (var e = 0; e < NUM_SPRITE_GOALKEEPER[CENTER_DOWN]; e++) s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[CENTER_DOWN] + e, "./js/vivo_futbol/sprites/goalkeeper_save_center_down/gk_save_center_down_" + e + ".png");
        for (var e = 0; e < NUM_SPRITE_GOALKEEPER[CENTER_UP]; e++) s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[CENTER_UP] + e, "./js/vivo_futbol/sprites/goalkeeper_save_center_up/gk_save_center_up_" + e + ".png");
        for (var e = 0; e < NUM_SPRITE_GOALKEEPER[LEFT_DOWN]; e++) s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[LEFT_DOWN] + e, "./js/vivo_futbol/sprites/goalkeeper_save_down_left/gk_save_down_left_" + e + ".png");
        for (var e = 0; e < NUM_SPRITE_GOALKEEPER[RIGHT_DOWN]; e++) s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[RIGHT_DOWN] + e, "./js/vivo_futbol/sprites/goalkeeper_save_down_right/gk_save_down_right_" + e + ".png");
        ...
        if (t !== !1) {
            ...
            s_iTimeElaps = n - s_iPrevTime, s_iCntTime += s_iTimeElaps, s_iCntFps++, s_iPrevTime = n, s_iCntTime >= 1e3 && (s_iCurFps = s_iCntFps, s_iCntTime -= 1e3, s_iCntFps = 0), c === STATE_GAME && s.update(), s_oStage.update(e)
        }
    }, s_oMain = this, n = e, this.initContainer()
}
...
function CGoal(e, t, n, i) {
    ...
    return this._init = function(e, t, n) {
        ...
        return o
    }, a = i, this._init(e, t, n), this
}

function CPause() {
    var e, t;
    return this._init = function() {
        e = new createjs.Container, e.alpha = 0, t = new createjs.Shape, t.graphics.beginFill("black").drawRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT), t.alpha = .5, t.on("click", function() {}), e.addChild(t);
        var n = new createjs.Text(TEXT_PAUSE, "70px " + FONT_GAME, TEXT_COLOR);
        n.x = .5 * CANVAS_WIDTH, n.y = .5 * CANVAS_HEIGHT - 100, n.textAlign = "center", e.addChild(n);
        var i = new createjs.Text(TEXT_PAUSE, "70px " + FONT_GAME, TEXT_COLOR_STROKE);
        i.x = .5 * CANVAS_WIDTH, i.y = .5 * CANVAS_HEIGHT - 100, i.outline = OUTLINE_WIDTH, i.textAlign = "center", e.addChild(i);
        var o, a = s_oSpriteLibrary.getSprite("but_continue");
        o = new CGfxButton(.5 * CANVAS_WIDTH, .5 * CANVAS_HEIGHT + 70, a, e), o.addEventListener(ON_MOUSE_UP, this._onLeavePause, this), s_oStage.addChild(e);
        var s = this;
...
function CPreloader() {
    var e, t, n, i, o, a, s, r;
    this._init = function() {
        s_oSpriteLibrary.init(this._onImagesLoaded, this._onAllImagesLoaded, this), s_oSpriteLibrary.addSprite("bg_menu", "./js/vivo_futbol/sprites/bg_menu.jpg"), s_oSpriteLibrary.addSprite("progress_bar", "./js/vivo_futbol/sprites/progress_bar.png"), s_oSpriteLibrary.loadSprites(), r = new createjs.Container, s_oStage.addChild(r)
    }, this.unload = function() {
        r.removeAllChildren()
    }, this.hide = function() {
        var e = this;
        ...
        o = createBitmap(c), o.x = CANVAS_WIDTH / 2 - c.width / 2, o.y = CANVAS_HEIGHT - 200, r.addChild(o), e = c.width, t = c.height, a = new createjs.Shape, a.graphics.beginFill("rgba(255,255,255,0.01)").drawRect(o.x, o.y, 1, t), r.addChild(a), o.mask = a, n = new createjs.Text("", "30px " + FONT_GAME, "#fff"), n.x = CANVAS_WIDTH / 2, n.y = CANVAS_HEIGHT - 200, n.textBaseline = "alphabetic", n.textAlign = "center", r.addChild(n), i = new createjs.Text("", "30px " + SECONDARY_FONT, "#fff"), i.x = CANVAS_WIDTH + 200, i.y = CANVAS_HEIGHT + 200, i.textBaseline = "alphabetic", i.textAlign = "center", r.addChild(i), s = new createjs.Shape, s.graphics.beginFill("black").drawRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT), s.alpha = 0, r.addChild(s)
...
function CTextButton(e, t, n, i, o, a, s) {
    var r, l, c;
    return this._init = function(e, t, n, i, o, a, s) {
        ...
        var _ = p.getBounds();
        p.x = n.width / 2, p.y = Math.floor(n.height / 2) + _.height / 3, c = new createjs.Container, c.x = e, c.y = t, c.regX = n.width / 2, c.regY = n.height / 2, c.addChild(d, u, p), s_bMobile || (c.cursor = "pointer"), s_oStage.addChild(c), this._initListener()
    }, this.unload = function() {
        ...
        c.scaleX = .9, c.scaleY = .9, r[ON_MOUSE_DOWN] && r[ON_MOUSE_DOWN].call(l[ON_MOUSE_DOWN])
    }, this.setPosition = function(e, t) {
        c.x = e, c.y = t
    }, this.setX = function(e) {
        c.x = e
...
function CCreditsPanel() {
    ...
    this[_0x3619[0]] = function() {
        ...
        a = new createjs.Shape, a[_0x3619[7]][_0x3619[6]](_0x3619[5])[_0x3619[4]](0, 0, CANVAS_WIDTH, CANVAS_HEIGHT), a[_0x3619[8]] = .5, a[_0x3619[10]](_0x3619[9], this._onLogoButRelease), a[_0x3619[11]] = _0x3619[12], l[_0x3619[1]](a), e = createBitmap(c), e[_0x3619[13]] = CANVAS_WIDTH_HALF, e[_0x3619[14]] = CANVAS_HEIGHT_HALF, e[_0x3619[15]] = .5 * c[_0x3619[16]], e[_0x3619[17]] = .5 * c[_0x3619[18]], l[_0x3619[1]](e), o = new createjs.Shape, o[_0x3619[7]][_0x3619[6]](_0x3619[19])[_0x3619[4]](CANVAS_WIDTH - 2 * EDGEBOARD_X, CANVAS_HEIGHT - 2 * EDGEBOARD_Y, 2 * EDGEBOARD_X, 2 * EDGEBOARD_Y), o[_0x3619[8]] = .01, o[_0x3619[10]](_0x3619[9], this[_0x3619[20]]), o[_0x3619[11]] = _0x3619[12], l[_0x3619[1]](o);
        var d = s_oSpriteLibrary[_0x3619[3]](_0x3619[21]);
        r = {
            x: .5 * CANVAS_WIDTH + 270,
            y: 181
        }, n = new CGfxButton(r[_0x3619[13]], r[_0x3619[14]], d, l), n[_0x3619[23]](ON_MOUSE_UP, this[_0x3619[22]], this), i = new createjs.Text(_0x3619[24], _0x3619[25] + FONT_GAME, _0x3619[26]), i[_0x3619[27]] = _0x3619[28], i[_0x3619[29]] = _0x3619[30], i[_0x3619[13]] = CANVAS_WIDTH / 2, i[_0x3619[14]] = 230, l[_0x3619[1]](i), d = s_oSpriteLibrary[_0x3619[3]](_0x3619[31]), t = createBitmap(d), t[_0x3619[15]] = d[_0x3619[16]] / 2, t[_0x3619[17]] = d[_0x3619[18]] / 2, t[_0x3619[13]] = CANVAS_WIDTH / 2, t[_0x3619[14]] = 310, l[_0x3619[1]](t), s = new createjs.Text(_0x3619[32], _0x3619[33] + FONT_GAME, _0x3619[26]), s[_0x3619[27]] = _0x3619[28], s[_0x3619[29]] = _0x3619[30], s[_0x3619[13]] = CANVAS_WIDTH / 2, s[_0x3619[14]] = 420, l[_0x3619[1]](s)
        ...
        if (5 === c) {
            ...
            n[_0x3619[1]](e), n[_0x3619[1]](t), n[_0x3619[13]] = CANVAS_WIDTH_HALF, n[_0x3619[14]] = -e[_0x3619[39]]()[_0x3619[18]], l[_0x3619[1]](n), createjs[_0x3619[48]][_0x3619[47]](n)[_0x3619[44]]({
...
function CLosePanel(e) {
    var t, n, i, o, a, s, r = null,
        l = !1;
    return this._init = function(e) {
        s = new createjs.Shape, s.graphics.beginFill("black").drawRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT), s.alpha = 0, s_oStage.addChild(s), o = new createjs.Container, o.alpha = 1, o.visible = !1, o.y = CANVAS_HEIGHT, t = createBitmap(e), t.x = CANVAS_WIDTH_HALF, t.y = CANVAS_HEIGHT_HALF, t.regX = .5 * e.width, t.regY = .5 * e.height, o.addChild(t), n = new createjs.Text("", "45px " + FONT_GAME, "#ffffff"), n.x = CANVAS_WIDTH / 2, n.y = CANVAS_HEIGHT_HALF, n.textAlign = "center", n.textBaseline = "middle", o.addChild(n), i = new createjs.Text("", "bold 100px " + FONT_GAME, "#ffffff"), i.x = CANVAS_WIDTH / 2, i.y = CANVAS_HEIGHT_HALF - 210, i.textAlign = "center", o.addChild(i), s_oStage.addChild(o);
        var l = s_oSpriteLibrary.getSprite("but_home");
        r = new CGfxButton(.5 * CANVAS_WIDTH - 360, .5 * CANVAS_HEIGHT + 180, l, o), r.addEventListener(ON_MOUSE_DOWN, this._onExit, this);
        var c = s_oSpriteLibrary.getSprite("but_restart");
        a = new CGfxButton(.5 * CANVAS_WIDTH + 360, .5 * CANVAS_HEIGHT + 180, c, o), a.addEventListener(ON_MOUSE_DOWN, this._onRestart, this), a.pulseAnimation()
    }, this.unload = function() {
        createjs.Tween.get(o).to({
            alpha: 0
        }, 500, createjs.Ease.cubicOut).call(function() {
        ...
        n.text = TEXT_LOSE_RESULT + " " + e + " " + TEXT_OF + " " + t + " " + TEXT_BALLS, i.text = TEXT_LOSE, o.visible = !0, createjs.Tween.get(s).to({
            alpha: .5
        }, 500, createjs.Ease.cubicOut), s.on("click", function() {}), createjs.Tween.get(o).wait(250).to({
            y: 0
        }, 1250, createjs.Ease.elasticOut).call(function() {
            s_iAdsLevel === NUM_LEVEL_FOR_ADS ? ($(s_oMain).trigger("show_interlevel_ad"), s_iAdsLevel = 1) : s_iAdsLevel++
        })
    }, this._onRestart = function() {
        l || (l = !0, this.unload(), createjs.Tween.get(s).to({
            alpha: 0
...
function CMenu() {
    ...
    this._init = function() {
        ...
        if (t = {
                ...
                y: CANVAS_HEIGHT - 130
            }, o = new CGfxButton(t.x, t.y, l), o.addEventListener(ON_MOUSE_UP, this._onButPlayRelease, this), o.pulseAnimation(), s_iBestScore = getItem(LOCALSTORAGE_STRING[LOCAL_BEST_SCORE]), null === s_iBestScore && (s_iBestScore = 0), DISABLE_SOUND_MOBILE === !1 || s_bMobile === !1) {
            var l = s_oSpriteLibrary.getSprite("audio_icon");
            e = {
                x: CANVAS_WIDTH - l.height / 2 - 10,
                y: l.height / 2 + 10
            }, r = new CToggle(e.x, e.y, l, s_bAudioActive), r.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this)
        }
        var c = s_oSpriteLibrary.getSprite("but_info");
        n = {
            x: l.height / 2 + 10,
            y: l.height / 2 + 10
        }, a = new CGfxButton(n.x, n.y, c, s_oStage), a.addEventListener(ON_MOUSE_UP, this._onButInfoRelease, this), s = new createjs.Shape, s.graphics.beginFill("black").drawRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT), s_oStage.addChild(s), createjs.Tween.get(s).to({
            alpha: 0
        }, 1e3).call(function() {
            s.visible = !1
...
function CHandSwipeAnim(e, t, n, i) {
    var o, a, s = i,
        ...
        c = !1;
    return this._init = function(e) {
        a = new createjs.Container, o = createBitmap(e), o.x = r.x, o.y = r.y, o.regX = .5 * e.width, o.regY = .5 * e.height, o.alpha = 0, s.addChild(a), a.addChild(o)
        ...
        createjs.Tween.get(o).to({
            ...
            alpha: 0
        }, .5 * MS_TIME_SWIPE_END, createjs.Ease.quartOut), createjs.Tween.get(o).to({
            x: l[0].x,
            y: l[0].y
        }, MS_TIME_SWIPE_END, createjs.Ease.quartOut).call(function() {
            o.x = r.x, o.y = r.y, createjs.Tween.get(o).to({
                alpha: 1
            }, .1 * MS_TIME_SWIPE_END).wait(.3 * MS_TIME_SWIPE_END).to({
                alpha: 0
            }, .5 * MS_TIME_SWIPE_END, createjs.Ease.quartOut), createjs.Tween.get(o).to({
...
TimeSeries.prototype.resetBounds = function() {
    ...
    for (var e = 0; e < this.data.length; e++) this.maxValue = isNaN(this.maxValue) ? this.data[e][1] : Math.max(this.maxValue, this.data[e][1]), this.minValue = isNaN(this.minValue) ? this.data[e][1] : Math.min(this.minValue, this.data[e][1])
}, TimeSeries.prototype.append = function(e, t) {
    this.lastTimeStamp = e;
    var n = this.dataPool.length ? this.dataPool.pop() : [e, t];
    for (n[0] = e, n[1] = t, this.data.push(n), this.maxValue = isNaN(this.maxValue) ? t : Math.max(this.maxValue, t), this.minValue = isNaN(this.minValue) ? t : Math.min(this.minValue, t); this.data.length > this.maxDataLength;) this.dataPool.push(this.data.shift())
    ...
    if (n.save(), t -= t % i.millisPerPixel, n.translate(o.left, o.top), n.beginPath(), n.rect(0, 0, o.width, o.height), n.clip(), n.save(), n.fillStyle = i.grid.fillStyle, n.clearRect(0, 0, o.width, o.height), n.fillRect(0, 0, o.width, o.height), n.restore(), n.save(), n.lineWidth = i.grid.lineWidth || 1, n.strokeStyle = i.grid.strokeStyle || "#ffffff", i.grid.millisPerLine > 0)
...
CANNON.Demo = function(e) {
    ...
    function n() {
        if (w) {
            ...
            for (var t in w.__folders)
                for (var e in w.__folders[t].__controllers) w.__folders[t].__controllers[e].updateDisplay()
        }
    }
    ...
    function r() {
            ...
            for (var o = 0; o < z.constraints.length; o++) {
                ...
                if (l instanceof CANNON.PointToPointConstraint) {
                    var E = l.equations.normal,
                        ...
                        t = _.id;
                    p.id;
                    f.scale.set(E.ri.x, E.ri.y, E.ri.z), m.scale.set(E.rj.x, E.rj.y, E.rj.z), g.scale.set(-E.penetrationVec.x, -E.penetrationVec.y, -E.penetrationVec.z), s(f.scale), s(m.scale), s(g.scale), f.position.copy(_.position), m.position.copy(p.position), E.bj.position.vadd(E.rj, g.position)
                }
            }
        }
        ...
        if (j.hideCached(), B.restart(), A.aabbs)
            for (var t = 0; t < v.length; t++) {
                var n = v[t];
                if (n.computeAABB && (n.aabbNeedsUpdate && n.computeAABB(), isFinite(n.aabb.lowerBound.x) && isFinite(n.aabb.lowerBound.y) && isFinite(n.aabb.lowerBound.z) && isFinite(n.aabb.upperBound.x) && isFinite(n.aabb.upperBound.y) && isFinite(n.aabb.upperBound.z) && n.aabb.lowerBound.x - n.aabb.upperBound.x != 0 && n.aabb.lowerBound.y - n.aabb.upperBound.y != 0 && n.aabb.lowerBound.z - n.aabb.upperBound.z != 0)) {
                    var r = B.request();
                    r.scale.set(n.aabb.lowerBound.x - n.aabb.upperBound.x, n.aabb.lowerBound.y - n.aabb.upperBound.y, n.aabb.lowerBound.z - n.aabb.upperBound.z), r.position.set(.5 * (n.aabb.lowerBound.x + n.aabb.upperBound.x), .5 * (n.aabb.lowerBound.y + n.aabb.upperBound.y), .5 * (n.aabb.lowerBound.z + n.aabb.upperBound.z))
                }
            }
        B.hideCached()
    }
    ...
    function l() {
        Z = document.createElement("div"), document.body.appendChild(Z), CAMERA_TEST_TRACKBALL ? (NEAR = 1, camera = new THREE.PerspectiveCamera(45, J / ee, NEAR, FAR), camera.lookAt(new THREE.Vector3(CAMERA_TEST_LOOK_AT.x, CAMERA_TEST_LOOK_AT.y, CAMERA_TEST_LOOK_AT.z)), camera.position.set(0, 500, 500), camera.up.set(0, 0, 1)) : camera = createOrthoGraphicCamera(), scene = g.scene = new THREE.Scene, scene.fog = new THREE.Fog(8306926, .5 * FAR, FAR), X = new THREE.AmbientLight(4473924), scene.add(X), W = new THREE.DirectionalLight(16777181, 1), W.position.set(180, 0, 180), W.target.position.set(0, 0, 0), W.castShadow = !0, W.shadow.camera.near = 10, W.shadow.camera.far = 100, W.shadow.camera.fov = FOV, W.shadowMapBias = .0139, W.shadowMapDarkness = .1, W.shadow.mapSize.width = q, W.shadow.mapSize.height = Q, new THREE.CameraHelper(W.shadow.camera), scene.add(W), scene.add(camera), renderer = SHOW_3D_RENDER ? new THREE.WebGLRenderer({
            clearColor: 0,
            clearAlpha: .5,
            antialias: !0,
            alpha: !0
            ...
            antialias: !1,
            alpha: !0
        }), renderer.setSize(J, ee), renderer.domElement.style.position = "relative", renderer.domElement.style.top = $ + "px", renderer.domElement.style.opacity = CANVAS_3D_OPACITY, Z.appendChild(renderer.domElement), U = document.createElement("div"), U.style.position = "absolute", U.style.top = "10px", U.style.width = "100%", U.style.textAlign = "center", U.innerHTML = '<a href="http://github.com/schteppe/cannon.js">cannon.js</a> - javascript 3d physics', Z.appendChild(U), document.addEventListener("mousemove", h), window.addEventListener("resize", u), renderer.setClearColor(scene.fog.color, 1), renderer.autoClear = !1, O = document.createElement("canvas"), O.width = J, O.height = ee, O.style.opacity = .5, O.style.position = "absolute", O.style.top = "0px", O.style.zIndex = 90, Z.appendChild(O), x = new SmoothieChart({
            labelOffsetY: 50,
        ...
        for (var o in z.profile) {
            var a = t[n % t.length];
            x.addTimeSeries(e[o], {
                strokeStyle: "rgb(" + a[0] + "," + a[1] + "," + a[2] + ")",
                lineWidth: 2
            }), n++
        }
        if (z.doProfiling = !1, x.stop(), O.style.display = "none", Y = new Stats, Y.domElement.style.position = "absolute", Y.domElement.style.top = "0px", Y.domElement.style.zIndex = 100, Z.appendChild(Y.domElement), void 0 != window.dat) {
            ...
            s.add(A, "rendermode", {
                ...
                i(e)
            }), s.add(A, "contacts"), s.add(A, "cm2contact"), s.add(A, "normals"), s.add(A, "constraints"), s.add(A, "axes"), s.add(A, "particleSize").min(0).max(1).onChange(function(e) {
            ...
            }), s.add(A, "aabbs"), s.add(A, "profiling").onChange(function(e) {
    ...
    var v = this.bodies = [],
        ...
        O = null,
        C = {},
        L = new THREE.SphereGeometry(.1, 6, 6),
        R = (this.particleGeo = new THREE.SphereGeometry(1, 16, 8), 11184810),
    ...
    var I = new THREE.MeshPhongMaterial({
        ...
        H = (this.particleMaterial = new THREE.MeshLambertMaterial({
            color: 16711680
        }), new m(function() {
        ...
        P = new m(function() {
            ...
            return e.vertices.push(new THREE.Vector3(0, 0, 0)), e.vertices.push(new THREE.Vector3(1, 1, 1)), new THREE.Line(e, new THREE.LineBasicMaterial({
                color: 16711680
            }))
        }),
        ...
        j = new m(function() {
            ...
            var a = new THREE.Line(n, new THREE.LineBasicMaterial({
                ...
                s = new THREE.Line(i, new THREE.LineBasicMaterial({
                    color: 65280
                })),
                r = new THREE.Line(o, new THREE.LineBasicMaterial({
                    color: 255
                }));
    ...
    var Z, q = 1024,
        ...
        ee = s_iCanvasResizeHeight + s_iCanvasOffsetHeight,
        te = J / 2,
        ne = ee / 2;
    l(), c();
    s_oRender = _, document.addEventListener("keypress", function(e) {
...
}, CANNON.Demo.prototype = new CANNON.EventTarget, CANNON.Demo.constructor = CANNON.Demo, CANNON.Demo.prototype.setGlobalSpookParams = function(e, t, n) {
    ...
    controls = new THREE.TransformControls(camera, renderer.domElement), scene.add(e), controls.attach(e, t), scene.add(controls), console.log("CREATE"), window.addEventListener("keydown", function(e) {
        switch (e.keyCode) {
            case 81:
            ...
            case CANNON.Shape.types.HEIGHTFIELD:
                for (var l = new THREE.Geometry, A = new CANNON.Vec3, S = new CANNON.Vec3, v = new CANNON.Vec3, b = 0; b < a.data.length - 1; b++)
                    for (var y = 0; y < a.data[b].length - 1; y++)
                        for (var w = 0; 2 > w; w++) {
                            a.getConvexTrianglePillar(b, y, 0 === w), A.copy(a.pillarConvex.vertices[0]), S.copy(a.pillarConvex.vertices[1]), v.copy(a.pillarConvex.vertices[2]), A.vadd(a.pillarOffset, A), S.vadd(a.pillarOffset, S), v.vadd(a.pillarOffset, v), l.vertices.push(new THREE.Vector3(A.x, A.y, A.z), new THREE.Vector3(S.x, S.y, S.z), new THREE.Vector3(v.x, v.y, v.z));
...
! function(e) {
    ...
    function() {
        ...
        function n(e) {
            h.enabled !== !1 && (window.removeEventListener("keydown", n), f = E, E === u.NONE && (e.keyCode !== h.keys[u.ROTATE] || h.noRotate ? e.keyCode !== h.keys[u.ZOOM] || h.noZoom ? e.keyCode !== h.keys[u.PAN] || h.noPan || (E = u.PAN) : E = u.ZOOM : E = u.ROTATE))
        }
        ...
        function o(e) {
            h.enabled !== !1 && (e.preventDefault(), e.stopPropagation(), E === u.NONE && (E = e.button), E !== u.ROTATE || h.noRotate ? E !== u.ZOOM || h.noZoom ? E !== u.PAN || h.noPan || (y.copy(L(e.pageX, e.pageY)), w.copy(y)) : (A.copy(L(e.pageX, e.pageY)), S.copy(A)) : (g.copy(R(e.pageX, e.pageY)), T.copy(g)), document.addEventListener("mousemove", a, !1), document.addEventListener("mouseup", s, !1), h.dispatchEvent(O))
        }

        function a(e) {
            h.enabled !== !1 && (e.preventDefault(), e.stopPropagation(), E !== u.ROTATE || h.noRotate ? E !== u.ZOOM || h.noZoom ? E !== u.PAN || h.noPan || w.copy(L(e.pageX, e.pageY)) : S.copy(L(e.pageX, e.pageY)) : T.copy(R(e.pageX, e.pageY)))
        }
        ...
        function r(e) {
            if (h.enabled !== !1) {
                ...
                var t = 0;
                e.wheelDelta ? t = e.wheelDelta / 40 : e.detail && (t = -e.detail / 3), A.y += .01 * t, h.dispatchEvent(O), h.dispatchEvent(C)
            }
        }
        ...
        var L = function() {
            ...
            R = function() {
                var e = new THREE.Vector3,
                    ...
                    n = new THREE.Vector3;
                return function(i, o) {
                    n.set((i - .5 * h.screen.width - h.screen.left) / (.5 * h.screen.width), (.5 * h.screen.height + h.screen.top - o) / (.5 * h.screen.height), 0);
                    var a = n.length();
                    return h.noRoll ? a < Math.SQRT1_2 ? n.z = Math.sqrt(1 - a * a) : n.z = .5 / a : a > 1 ? n.normalize() : n.z = Math.sqrt(1 - a * a), m.copy(h.object.position).sub(h.target), e.copy(h.object.up).setLength(n.y), e.add(t.copy(h.object.up).cross(m).setLength(n.x)), e.add(m.setLength(n.z)), e
                }
            }();
        this.rotateCamera = function() {
            ...
            return function() {
                ...
                n && (e.crossVectors(g, T).normalize(), n *= h.rotateSpeed, t.setFromAxisAngle(e, -n), m.applyQuaternion(t), h.object.up.applyQuaternion(t), T.applyQuaternion(t), h.staticMoving ? g.copy(T) : (t.setFromAxisAngle(e, n * (h.dynamicDampingFactor - 1)), g.applyQuaternion(t)))
            }
            ...
            var e = new THREE.Vector2,
                ...
                n = new THREE.Vector3;
            return function() {
                e.copy(w).sub(y), e.lengthSq() && (e.multiplyScalar(m.length() * h.panSpeed), n.copy(m).cross(h.object.up).setLength(e.x), n.add(t.copy(h.object.up).setLength(e.y)), h.object.position.add(n), h.target.add(n), h.staticMoving ? y.copy(w) : y.add(e.subVectors(w, y).multiplyScalar(h.dynamicDampingFactor)))
            }
        }(), this.checkDistances = function() {
            h.noZoom && h.noPan || (m.lengthSq() > h.maxDistance * h.maxDistance && h.object.position.addVectors(h.target, m.setLength(h.maxDistance)), m.lengthSq() < h.minDistance * h.minDistance && h.object.position.addVectors(h.target, m.setLength(h.minDistance)))
        }, this.update = function() {
            m.subVectors(h.object.position, h.target), h.noRotate || h.rotateCamera(), h.noZoom || h.zoomCamera(), h.noPan || h.panCamera(), h.object.position.addVectors(h.target, m), h.checkDistances(), h.object.lookAt(h.target), p.distanceToSquared(h.object.position) > _ && (h.dispatchEvent(x), p.copy(h.object.position))
        }, this.reset = function() {
            E = u.NONE, f = u.NONE, h.target.copy(h.target0), h.object.position.copy(h.position0), h.object.up.copy(h.up0), m.subVectors(h.object.position, h.target), h.object.lookAt(h.target), h.dispatchEvent(x), p.copy(h.object.position)
...
var s_oInterface = null,
    s_oScenario, s_bMobile, s_bAudioActive = !0,
    s_bFullscreen = !1,
    s_iCntTime = 0,
    s_iTimeElaps = 0,
    s_iPrevTime = 0,
    ...
    s_iBestScore = 0,
    s_oDrawLayer, s_oStage, s_oMain, s_oSpriteLibrary, s_oSoundTrack, dat = dat || {};
dat.gui = dat.gui || {}, dat.utils = dat.utils || {}, dat.controllers = dat.controllers || {}, dat.dom = dat.dom || {}, dat.color = dat.color || {}, dat.utils.css = function() {
    ...
    var i = function(e, o, a) {
        i.superclass.call(this, e, o), a = a || {}, this.__min = a.min, this.__max = a.max, this.__step = a.step, t.isUndefined(this.__step) ? 0 == this.initialValue ? this.__impliedStep = 1 : this.__impliedStep = Math.pow(10, Math.floor(Math.log(this.initialValue) / Math.LN10)) / 10 : this.__impliedStep = this.__step, this.__precision = n(this.__impliedStep)
    };
    ...
    var o = function(e, i, a) {
        ...
        var h, u = this;
        this.__input = document.createElement("input"), this.__input.setAttribute("type", "text"), t.bind(this.__input, "change", s), t.bind(this.__input, "blur", r), t.bind(this.__input, "mousedown", l), t.bind(this.__input, "keydown", function(e) {
    ...
    var n, i, o = function() {
            ...
            return t.each(a, function(o) {
                return o.litmus(e) ? (t.each(o.conversions, function(o, a) {
    ...
    return o
}(dat.color.toString, dat.utils.common), dat.GUI = dat.gui.GUI = function(e, t, n, i, o, a, s, r, l, c, d, h, u, _, p) {
    function E(e, t, n, a) {
    ...
    function m(e, t, n) {
        if (n.__li = t, n.__gui = e, p.extend(n, {
                options: function(t) {
                    return arguments.length > 1 ? (n.remove(), E(e, n.object, n.property, {
                        before: n.__li.nextElementSibling,
                        factoryArgs: [p.toArray(arguments)]
                    })) : p.isArray(t) || p.isObject(t) ? (n.remove(), E(e, n.object, n.property, {
                        before: n.__li.nextElementSibling,
                        factoryArgs: [t]
                    })) : void 0
                },
            ...
            var i = new r(n.object, n.property, {
                min: n.__min,
                max: n.__max,
                step: n.__step
            });
            ...
            }), _.addClass(t, "has-slider"), n.domElement.insertBefore(i.domElement, n.domElement.firstElementChild)
        } else if (n instanceof r) {
            var o = function(t) {
                return p.isNumber(n.__min) && p.isNumber(n.__max) ? (n.remove(), E(e, n.object, n.property, {
                    before: n.__li.nextElementSibling,
                    factoryArgs: [n.__min, n.__max, n.__step]
                })) : t
            };
            n.min = p.compose(o, n.min), n.max = p.compose(o, n.max)
        } else n instanceof a ? (_.bind(t, "click", function() {
        ...
        })) : n instanceof d && (_.addClass(t, "color"), n.updateDisplay = p.compose(function(e) {
    ...
    function A(e) {
        ...
        if (e.load && e.load.remembered ? p.each(e.load.remembered, function(t, n) {
                y(e, n, n == e.preset)
            }) : y(e, I, !1), _.bind(r, "change", function() {
                for (var t = 0; t < e.__preset_select.length; t++) e.__preset_select[t].innerHTML = e.__preset_select[t].value;
                e.preset = this.value
            }), n.appendChild(r), n.appendChild(i), n.appendChild(o), n.appendChild(a), n.appendChild(s), H) {
            ...
            "true" === localStorage.getItem(T(e, "isLocal")) && d.setAttribute("checked", "checked"), t(), _.bind(d, "change", function() {
    ...
    var C, L, R = "dg",
        ...
        B = function(e) {
            ...
            var i = this;
            this.domElement = document.createElement("div"), this.__ul = document.createElement("ul"), this.domElement.appendChild(this.__ul), _.addClass(this.domElement, R), this.__folders = {}, this.__controllers = [], this.__rememberedObjects = [], this.__rememberedObjectIndecesToControllers = [], this.__listening = [], e = e || {}, e = p.defaults(e, {
                autoPlace: !0,
                ...
                preset: I
            } : e.preset && (e.load.preset = e.preset), p.isUndefined(e.parent) && e.hideable && D.push(this), e.resizable = p.isUndefined(e.parent) && e.resizable, e.autoPlace && p.isUndefined(e.scrollable) && (e.scrollable = !0);
            ...
            if (Object.defineProperties(this, {
                ...
                this.__closeButton = document.createElement("div"), this.__closeButton.innerHTML = B.TEXT_CLOSED, _.addClass(this.__closeButton, B.CLASS_CLOSE_BUTTON), this.domElement.appendChild(this.__closeButton), _.bind(this.__closeButton, "click", function() {
                    i.closed = !i.closed
                })
            } else {
            ...
            e.autoPlace && (p.isUndefined(e.parent) && (P && (L = document.createElement("div"), _.addClass(L, R), _.addClass(L, B.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(L), P = !1), L.appendChild(this.domElement), _.addClass(this.domElement, B.CLASS_AUTO_PLACE)), this.parent || v(i, e.width)), _.bind(window, "resize", function() {
                i.onResize()
                ...
                i.onResize()
            }), this.onResize(), e.resizable && S(this);
            i.getRoot();
            e.parent || n()
        };
    return B.toggleHide = function() {
        G = !G, p.each(D, function(e) {
            e.domElement.style.zIndex = G ? -999 : 999, e.domElement.style.opacity = G ? 0 : 1
        })
    }, B.CLASS_AUTO_PLACE = "a", B.CLASS_AUTO_PLACE_CONTAINER = "ac", B.CLASS_MAIN = "main", B.CLASS_CONTROLLER_ROW = "cr", B.CLASS_TOO_TALL = "taller-than-window", B.CLASS_CLOSED = "closed", B.CLASS_CLOSE_BUTTON = "close-button", B.CLASS_DRAG = "drag", B.DEFAULT_WIDTH = 245, B.TEXT_CLOSED = "Close Controls", B.TEXT_OPEN = "Open Controls", _.bind(window, "keydown", function(e) {
        ...
        onResize: function() {
            ...
            if (e.scrollable) {
                ...
                }), window.innerHeight - t - M < n ? (_.addClass(e.domElement, B.CLASS_TOO_TALL), e.__ul.style.height = window.innerHeight - t - M + "px") : (_.removeClass(e.domElement, B.CLASS_TOO_TALL), e.__ul.style.height = "auto")
            }
        ...
        getSaveObject: function() {
            var e = this.load;
            return e.closed = this.closed, this.__rememberedObjects.length > 0 && (e.preset = this.preset, e.remembered || (e.remembered = {}), e.remembered[this.preset] = b(this)), e.folders = {}, p.each(this.__folders, function(t, n) {
    ...
    return function(r, l) {
        var c = r[l];
        return s.isArray(arguments[2]) || s.isObject(arguments[2]) ? new e(r, l, arguments[2]) : s.isNumber(c) ? s.isNumber(arguments[2]) && s.isNumber(arguments[3]) ? new n(r, l, arguments[2], arguments[3]) : new t(r, l, {
            min: arguments[2],
            max: arguments[3]
        }) : s.isString(c) ? new i(r, l) : s.isFunction(c) ? new o(r, l, "") : s.isBoolean(c) ? new a(r, l) : void 0
    }
    ...
    var i = function(e, n) {
        ...
        i.superclass.call(this, e, n);
        var s = this;
        this.__input = document.createElement("input"), this.__input.setAttribute("type", "text"), t.bind(this.__input, "keyup", o), t.bind(this.__input, "change", o), t.bind(this.__input, "blur", a), t.bind(this.__input, "keydown", function(e) {
    ...
    var r = function(e, l) {
        ...
        o.extend(this.__selector.style, {
            ...
            height: "100%",
            background: "none"
        }), a(f, "top", "rgba(0,0,0,0)", "#000"), o.extend(this.__hue_field.style, {
            width: "15px",
            height: "100px",
            display: "inline-block",
            border: "1px solid #555",
        ...
        }), this.__saturation_field.appendChild(f), this.__selector.appendChild(this.__field_knob), this.__selector.appendChild(this.__saturation_field), this.__selector.appendChild(this.__hue_field), this.__hue_field.appendChild(this.__hue_knob), this.domElement.appendChild(this.__input), this.domElement.appendChild(this.__selector), this.updateDisplay()
    };
    r.superclass = e, o.extend(r.prototype, e.prototype, {
        updateDisplay: function() {
            ...
            }), this.__hue_knob.style.marginTop = 100 * (1 - this.__color.h / 360) + "px", this.__temp.s = 1, this.__temp.v = 1, a(this.__saturation_field, "left", "#fff", this.__temp.toString()), o.extend(this.__input.style, {
    ...
    }), o(l.prototype, "r", 2), o(l.prototype, "g", 1), o(l.prototype, "b", 0), a(l.prototype, "h"), a(l.prototype, "s"), a(l.prototype, "v"), Object.defineProperty(l.prototype, "a", {
        get: function() {
    ...
    return {
        ...
        rgb_to_hsv: function(e, t, n) {
            ...
            return 0 == s ? {
                ...
                s: 0,
                v: 0
            } : (o = r / s, i = e == s ? (t - n) / r : t == s ? 2 + (n - e) / r : 4 + (e - t) / r, i /= 6, 0 > i && (i += 1), {
                h: 360 * i,
                s: o,
                v: s / 255
            })
...
! function() {
    ...
    THREE.TransformGizmo = function() {
        ...
        var i = new THREE.Geometry,
            o = new THREE.Mesh(new THREE.CylinderGeometry(0, .05, .2, 12, 1, !1));
        o.position.y = .5, o.updateMatrix(), i.merge(o.geometry, o.matrix);
        ...
        r.addAttribute("position", new THREE.Float32Attribute([0, 0, 0, 0, 0, 1], 3)), this.handleGizmos = {
            X: [
                [new THREE.Mesh(i, new e({
                        color: 16711680
                    })), [.5, 0, 0],
                    [0, 0, -Math.PI / 2]
                ],
        ...
        var e = function(e, t, n) {
            var i = new THREE.BufferGeometry,
                o = [];
            n = n ? n : 1;
            for (var a = 0; 64 * n >= a; ++a) "x" === t && o.push(0, Math.cos(a / 32 * Math.PI) * e, Math.sin(a / 32 * Math.PI) * e), "y" === t && o.push(Math.cos(a / 32 * Math.PI) * e, 0, Math.sin(a / 32 * Math.PI) * e), "z" === t && o.push(Math.sin(a / 32 * Math.PI) * e, Math.cos(a / 32 * Math.PI) * e, 0);
        ...
        this.handleGizmos = {
            ...
            var n = ({
                ...
                h = t.clone();
            i.copy(this.planes.XY.rotation), o.setFromEuler(i), n.makeRotationFromQuaternion(o).getInverse(n), h.applyMatrix4(n), this.traverse(function(e) {
                o.setFromEuler(i), "X" === e.name && (l.setFromAxisAngle(a, Math.atan2(-h.y, h.z)), o.multiplyQuaternions(o, l), e.quaternion.copy(o)), "Y" === e.name && (c.setFromAxisAngle(s, Math.atan2(h.x, h.z)), o.multiplyQuaternions(o, c), e.quaternion.copy(o)), "Z" === e.name && (d.setFromAxisAngle(r, Math.atan2(h.y, h.x)), o.multiplyQuaternions(o, d), e.quaternion.copy(o))
            })
        }, this.init()
        ...
        THREE.TransformGizmo.call(this);
        var i = new THREE.Geometry,
            o = new THREE.Mesh(new THREE.BoxGeometry(.125, .125, .125));
        o.position.y = .5, o.updateMatrix(), i.merge(o.geometry, o.matrix);
        var a = new THREE.BufferGeometry;
        a.addAttribute("position", new THREE.Float32Attribute([0, 0, 0, 1, 0, 0], 3));
        var s = new THREE.BufferGeometry;
            ...
            if (void 0 !== r.object && c !== !0 && (void 0 === e.button || 0 === e.button)) {
                ...
                if (0 === t.button || void 0 === t.button) {
                    ...
                    if (n) {
                        ...
                        i && (D.copy(r.object.position), B.copy(r.object.scale), F.extractRotation(r.object.matrix), W.extractRotation(r.object.matrixWorld), V.extractRotation(r.object.parent.matrixWorld), k.setFromMatrixScale(x.getInverse(r.object.parent.matrixWorld)), A.copy(i.point))
                    }
                }
                c = !0
            }
        ...
        function o(e) {
            if (void 0 !== r.object && null !== r.axis && c !== !1 && (void 0 === e.button || 0 === e.button)) {
                ...
                n !== !1 && (e.preventDefault(), e.stopPropagation(), T.copy(n.point), "translate" === l ? (T.sub(A), T.multiply(k), "local" === r.space && (T.applyMatrix4(x.getInverse(W)), -1 === r.axis.search("X") && (T.x = 0), -1 === r.axis.search("Y") && (T.y = 0), -1 === r.axis.search("Z") && (T.z = 0), T.applyMatrix4(F), r.object.position.copy(D), r.object.position.add(T), r.body.position.copy(r.object.position)), "world" !== r.space && -1 === r.axis.search("XYZ") || (-1 === r.axis.search("X") && (T.x = 0), -1 === r.axis.search("Y") && (T.y = 0), -1 === r.axis.search("Z") && (T.z = 0), T.applyMatrix4(x.getInverse(V)), r.object.position.copy(D), r.object.position.add(T), r.body.position.copy(r.object.position)), null !== r.translationSnap && ("local" === r.space && r.object.position.applyMatrix4(x.getInverse(W)), -1 !== r.axis.search("X") && (r.object.position.x = Math.round(r.object.position.x / r.translationSnap) * r.translationSnap), -1 !== r.axis.search("Y") && (r.object.position.y = Math.round(r.object.position.y / r.translationSnap) * r.translationSnap), -1 !== r.axis.search("Z") && (r.object.position.z = Math.round(r.object.position.z / r.translationSnap) * r.translationSnap), "local" === r.space && r.object.position.applyMatrix4(W))) : "scale" === l ? (T.sub(A), T.multiply(k), "local" === r.space && ("XYZ" === r.axis ? (b = 1 + T.y / Math.max(B.x, B.y, B.z), r.object.scale.x = B.x * b, r.object.scale.y = B.y * b, r.object.scale.z = B.z * b) : (T.applyMatrix4(x.getInverse(W)), "X" === r.axis && (r.object.scale.x = B.x * (1 + T.x / B.x)), "Y" === r.axis && (r.object.scale.y = B.y * (1 + T.y / B.y)), "Z" === r.axis && (r.object.scale.z = B.z * (1 + T.z / B.z))))) : "rotate" === l && (T.sub(j), T.multiply(k), O.copy(A).sub(j), O.multiply(k), "E" === r.axis ? (T.applyMatrix4(x.getInverse(y)), O.applyMatrix4(x.getInverse(y)), S.set(Math.atan2(T.z, T.y), Math.atan2(T.x, T.z), Math.atan2(T.y, T.x)), v.set(Math.atan2(O.z, O.y), Math.atan2(O.x, O.z), Math.atan2(O.y, O.x)), C.setFromRotationMatrix(x.getInverse(V)), G.setFromAxisAngle(w, S.z - v.z), M.setFromRotationMatrix(W), C.multiplyQuaternions(C, G), C.multiplyQuaternions(C, M), r.object.quaternion.copy(C), r.body.quaternion.copy(C)) : "XYZE" === r.axis ? (G.setFromEuler(T.clone().cross(O).normalize()), C.setFromRotationMatrix(x.getInverse(V)), I.setFromAxisAngle(G, -T.clone().angleTo(O)), M.setFromRotationMatrix(W), C.multiplyQuaternions(C, I), C.multiplyQuaternions(C, M), r.object.quaternion.copy(C), r.body.quaternion.copy(C)) : "local" === r.space ? (T.applyMatrix4(x.getInverse(W)), O.applyMatrix4(x.getInverse(W)), S.set(Math.atan2(T.z, T.y), Math.atan2(T.x, T.z), Math.atan2(T.y, T.x)), v.set(Math.atan2(O.z, O.y), Math.atan2(O.x, O.z), Math.atan2(O.y, O.x)), M.setFromRotationMatrix(F), null !== r.rotationSnap ? (I.setFromAxisAngle(L, Math.round((S.x - v.x) / r.rotationSnap) * r.rotationSnap), H.setFromAxisAngle(R, Math.round((S.y - v.y) / r.rotationSnap) * r.rotationSnap), P.setFromAxisAngle(N, Math.round((S.z - v.z) / r.rotationSnap) * r.rotationSnap)) : (I.setFromAxisAngle(L, S.x - v.x), H.setFromAxisAngle(R, S.y - v.y), P.setFromAxisAngle(N, S.z - v.z)), "X" === r.axis && M.multiplyQuaternions(M, I), "Y" === r.axis && M.multiplyQuaternions(M, H), "Z" === r.axis && M.multiplyQuaternions(M, P), r.object.quaternion.copy(M), r.body.quaternion.copy(M)) : "world" === r.space && (S.set(Math.atan2(T.z, T.y), Math.atan2(T.x, T.z), Math.atan2(T.y, T.x)), v.set(Math.atan2(O.z, O.y), Math.atan2(O.x, O.z), Math.atan2(O.y, O.x)), C.setFromRotationMatrix(x.getInverse(V)), null !== r.rotationSnap ? (I.setFromAxisAngle(L, Math.round((S.x - v.x) / r.rotationSnap) * r.rotationSnap), H.setFromAxisAngle(R, Math.round((S.y - v.y) / r.rotationSnap) * r.rotationSnap), P.setFromAxisAngle(N, Math.round((S.z - v.z) / r.rotationSnap) * r.rotationSnap)) : (I.setFromAxisAngle(L, S.x - v.x), H.setFromAxisAngle(R, S.y - v.y), P.setFromAxisAngle(N, S.z - v.z)), M.setFromRotationMatrix(W), "X" === r.axis && C.multiplyQuaternions(C, I), "Y" === r.axis && C.multiplyQuaternions(C, H), "Z" === r.axis && C.multiplyQuaternions(C, P), C.multiplyQuaternions(C, M), r.object.quaternion.copy(C), r.body.quaternion.copy(C))), r.update(), r.dispatchEvent(_), r.dispatchEvent(f))
            }
        }
        ...
        THREE.Object3D.call(this), t = void 0 !== t ? t : document, this.body = void 0, this.object = void 0, this.visible = !1, this.translationSnap = null, this.rotationSnap = null, this.space = "world", this.size = 1, this.axis = null;
        var r = this,
            l = "translate",
            c = !1,
            d = {
        ...
        t.addEventListener("mousedown", i, !1), t.addEventListener("touchstart", i, !1), t.addEventListener("mousemove", n, !1), t.addEventListener("touchmove", n, !1), t.addEventListener("mousemove", o, !1), t.addEventListener("touchmove", o, !1), t.addEventListener("mouseup", a, !1), t.addEventListener("mouseout", a, !1), t.addEventListener("touchend", a, !1), t.addEventListener("touchcancel", a, !1), t.addEventListener("touchleave", a, !1), this.dispose = function() {
            ...
            void 0 !== r.object && (r.object.updateMatrixWorld(), j.setFromMatrixPosition(r.object.matrixWorld), z.setFromRotationMatrix(x.extractRotation(r.object.matrixWorld)), e.updateMatrixWorld(), X.setFromMatrixPosition(e.matrixWorld), Y.setFromRotationMatrix(x.extractRotation(e.matrixWorld)), b = j.distanceTo(X) / 6 * r.size, this.position.copy(j), this.scale.set(b, b, b), w.copy(X).sub(j).normalize(), "local" === r.space ? d[l].update(z, w) : "world" === r.space && d[l].update(new THREE.Euler, w), d[l].highlight(r.axis))
        }
